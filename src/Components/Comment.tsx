...
function Comment({}: Props): ReactElement {
    return (
        <div className='w-[100%] bg-white md:h-[150px] mt-[5%] rounded-lg flex justify-center'>
            <div className='w-[100%] h-[80%] grid md:grid-cols-8 my-auto '>
                <div className='flex justify-center '>
                    <div className='rounded-xl hidden md:block text-center flex flex-col justify-center items-center text-sm font-semibold h-[50px] bg-[#F2F4FF] px-4 text-center '>
                ...
                <div className='flex flex-row hidden md:block justify-center items-center gap-x-2'>
